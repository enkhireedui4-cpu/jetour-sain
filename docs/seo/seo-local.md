...
|---|---|---|---|
| Шоурум (Чингэлтэй) | `47.9210074, 106.9015123` | `16164080384796614770` | «Sain Motors-Сайн Моторс-Jetour» бүртгэл (`rb.gy/xji02i`) |
| Үйлчилгээний төв (ТЭЦ-4) | `47.897841, 106.796819` | — (бүртгэлгүй, зүү) | Sain Motors-ийн тавьсан зүү |
...
- [ ] Утас: шоурум `7277-8855` · үйлчилгээний төв `7010-8855` — **хоёр өөр
      дугаар**, GBP-ийн тус тусын бүртгэлд зөв тавигдсан байх
