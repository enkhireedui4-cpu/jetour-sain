...
export const BRANCHES: Branch[] = [
  {
    id: "showroom-chingeltei",
    name: "JETOUR Шоурум",
    nameEn: "JETOUR Showroom",
    type: "all-in-one",
    category: "Борлуулалт · Тест драйв · Зөвлөгөө",
    /* Хаягийг Sain Motors-ийн өгсөн найруулгаар нь бичив (ХИД-1, C1 ТВ-ийн
       байр — Улаанбаатарт танигдсан тэмдэглэгээ). */
    address:
      "Чингэлтэй дүүрэг, 5-р хороо, Хуучнаар ХИД-1, C1 ТВ-ийн байр, Holiday Inn зочид буудлын урд",
    ...
    /** Зөвхөн `geo` байхгүй үеийн нөөц зам — координат байгаа тул хэрэглэгдэхгүй */
     ...
     * Holiday Inn-ээс 250 м — «буудлын урд» гэсэн хаягтай тохирохыг
     * тооцоолж шалгасан.
     */
    geo: { lat: 47.9210074, lng: 106.9015123 },
    /**
     * 0xe052597810a96072 → аравтад. «Байршил харах» нь Google дээрх бодит
     * бүртгэл рүү орно (нэр, ажлын цаг, зураг, сэтгэгдэл, «Залгах» товч).
     *
     * `mapShareLink` (rb.gy богино холбоос) тавиагүй: бүртгэлтэй цэгт
     * `cid` хаяг нь ижил газрыг заах ба хугацаа дуусдаггүй. Сервис төвд
     * харин Google бүртгэл байхгүй (зөвхөн зүү) тул тэнд хуваалцсан
     * холбоосыг хэрэглэсэн.
     */
