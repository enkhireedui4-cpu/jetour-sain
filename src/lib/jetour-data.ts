...
export const SPECIAL_OFFERS: SpecialOffer[] = [
  {
    ...
    body: [
      ...
      "Уужим долоон суудал, өргөн ачааны багтаамж, нямбай өнгөлгөө нь гэр бүлийн урт замын аялалд ч, хотын өдөр тутмын хэрэглээнд ч адилхан тохирно. Панорам люк, хос дижитал дэлгэц, ухаалаг агааржуулалт зэрэг тохь тухыг нэмэх өдөөлтүүд бүрэн бий.",
