...
const NAV_LINKS: NavItem[] = [
  { label: "Тусгай санал", href: "/special-offers", type: "route" },
  {
    ...
    items: [
      ...
      /* «Дилер» гэдэг нь салбарын төрлийг л хэлдэг, хэрэглэгчид тэнд ЮУ
         байгааг хэлдэггүй. Шоурум (борлуулалт) ба сервис төв (засвар) хоёрыг
         нэрлэвэл цэснээс шууд ойлгогдоно. */
      { label: "Шоурум ба Сервис төв", href: "/dealer", type: "route" },
    ],
  },
  {
