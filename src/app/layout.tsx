...
export const metadata: Metadata = {
  ...
  description:
    "JETOUR — Монгол дахь албан ёсны дистрибьютор Сайн Моторс ХХК. X70 Plus, X1, X50, T1, T2 загварууд. Шоурум Баянзүрх дүүрэгт, сервис төв Хан-Уул дүүрэгт. Тест драйв, борлуулалт, баталгаат засвар. Утас: 7010-8855",
  keywords: [
